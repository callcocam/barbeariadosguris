...
class TaggingUtility
{
    ...
    public static function normalize($string)
    {
        ...
        if(is_string($normalizer) && Str::contains($normalizer, 'App\Suports\Tagging\Util')) {
            $normalizer = '\App\Suports\Tagging\TaggingUtility::slug';
        }
    ...
    {
        return config('tagging.tag_model', '\App\Suports\Tagging\Model\Tag');
    }
    ...
    {
        return config('tagging.tagged_model', 'App\Suports\Tagging\Model\Tagged');
    }
}
